  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur border-b border-[#1a1a1a]">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        {/* AI Badge — center */}
        <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-2 px-4 py-1.5 border border-[#b01c1c]/50 rounded-full bg-black/60 backdrop-blur-sm">
