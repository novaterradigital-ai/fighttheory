...
export const metadata: Metadata = {
  title: "Fight Theory | Elite Combat Sports Picks",
  description: "Data-driven MMA & boxing picks with proven ROI. Join the sharpest combat sports betting community.",
  icons: {
    icon: "/logo.png",
    apple: "/logo.png",
  },
