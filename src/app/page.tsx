  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="w-full pt-16 relative">
        ...
        {/* Fade + buttons overlaid at the bottom */}
        <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-black to-transparent pointer-events-none" />
        <div className="absolute bottom-6 left-0 right-0 px-4 flex flex-col sm:flex-row gap-3 justify-center items-center max-w-lg mx-auto">
          <Link
            href="/picks"
            className="w-full sm:flex-1 py-4 bg-white text-black font-black uppercase tracking-widest text-sm rounded hover:bg-gray-200 transition-colors duration-200 text-center"
          >
            View Public Picks
          </Link>
          <Link
            href="/inner-circle"
            className="w-full sm:flex-1 py-4 bg-[#b01c1c] text-white font-black uppercase tracking-widest text-sm rounded hover:bg-[#8b1010] transition-colors duration-200 text-center"
          >
